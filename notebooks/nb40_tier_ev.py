#!/usr/bin/env python
"""nb40 - measure EV/trade per candle-quality bucket (renamed 2026-09-15).

**Renaming note**: the original notebook used the labels A/B/C/D
("tier"). The renamed system in v2 calls them **HUNT /
STRONG_ALIGNED / TRUE_DISPLACEMENT / MARGINAL**. This notebook
still uses the legacy A/B/C/D labels internally because it's a
standalone study script. The mapping is:
